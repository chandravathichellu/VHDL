...
HD_PWD='E:/1sem/VIVADO/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ASYUPSTR.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ASYUPSTR.tcl -notrace
